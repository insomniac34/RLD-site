...
angular.module( 'RabornLandscapeDesign', ['ngRoute', 'ngAnimate', 'ui.bootstrap'])
    ...
    .controller('GivingBackController', ['$log', '$scope', '$location', '$anchorScroll', function GivingBackController($log, $scope, $location, $anchorScroll) {
      ...
      $scope.windows = [
       ...
       {visible: true, title: "Penn Forest Natural Burial Park", altTitle: "Penn Forest", content: "I designed a forest showing the location and species of memorial trees to be planted. I give an environmentally themed talk at the open house/picnic each year.", images: [{title: 'Penn Forest Burial Park', src: 'img/pfbp-img.png', hover: false, isLink: true, url: 'http://www.pennforestcemetery.com'}], bulletPoints: []},
       {visible: true, title: "Pittsburgh Botanical Garden", altTitle: "Pittsburgh Botanical Garden", content: "I work at the annual plant sale raising money to help transform 460 acres of abandoned mining land into a world class botanic garden. Member since 1998.", images: [{title: 'Pittsburgh Botanical Garden', src: 'img/pbg-img.png', hover: false, isLink: true, url: 'http://www.pittsburghbotanicgarden.org/'}], bulletPoints: []},        
